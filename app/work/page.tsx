    ...
    <main>
      <section className="border-b-2 border-[var(--c4-black)] px-5 py-14 md:px-10 md:py-20">
        <div className="mx-auto max-w-[1440px]">
          ...
          <h1 className="display mt-3 min-w-0 text-[clamp(1.85rem,8.5vw,3rem)] font-extrabold uppercase md:text-6xl">
      ...
      <section className="border-b-2 border-[var(--c4-black)] px-5 py-14 md:px-10">
        <div className="mx-auto grid max-w-[1440px] gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal variant="right" delay={0.08}>
            ...
            <h2 className="display mt-3 text-[clamp(1.5rem,6vw,1.875rem)] font-extrabold uppercase md:text-4xl">
        ...
        <div className="mx-auto grid max-w-[1440px] grid-cols-2 gap-10 md:grid-cols-4 md:gap-8">
          {stats.map((stat, i) => (
            <Reveal key={stat.label} delay={i * 0.06} variant="scale" className="text-center">
              <p className="display text-[clamp(1.75rem,8vw,2.25rem)] font-extrabold uppercase leading-none tracking-tight md:text-5xl lg:text-6xl">
                {stat.value}
              </p>
      ...
      <section className="border-b-2 border-[var(--c4-black)] px-5 py-14 md:px-10">
        <div className="mx-auto max-w-[1440px]">
          <Reveal>
            <h2 className="display text-[clamp(1.65rem,6.5vw,1.875rem)] font-extrabold uppercase">Case Studies</h2>
          </Reveal>
              ...
              return (
                <article key={study.title} className="border-2 border-[var(--c4-black)]">
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="display mt-2 text-[clamp(1.05rem,4.2vw,1.25rem)] font-bold uppercase leading-tight">
                      {study.title}
                    </h3>
      ...
      <Reveal as="section" className="c4-block-black px-5 py-16 md:px-10 md:py-20">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="display text-[clamp(1.65rem,6.5vw,1.875rem)] font-extrabold uppercase">
